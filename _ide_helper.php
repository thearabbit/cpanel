...
namespace {
    ...
    class UArrays extends \Underscore\Types\Arrays{
        
    }


    class UObject extends \Underscore\Types\Object{
        
    }


    class UNumber extends \Underscore\Types\Number{
        
    }


    class UString extends \Underscore\Types\String{
        
    }


    class UFunctions extends \Underscore\Types\Functions{
        
    }


    class UParse extends \Underscore\Parse{
    ...
    class MarkdownPlus extends \Maxxscho\LaravelMarkdownPlus\Facade\LaravelMarkdownPlusFacade{
        ...
        public static function make($source){
            return \Maxxscho\LaravelMarkdownPlus\MarkdownPlus::make($source);
        }
    ...
    class BSForm extends \Bootstrapper\Facades\Form{
    ...
    class EmptyClass extends \Rabbit\Cpanel\Libraries\EmptyClass{
        
    }


    class Action extends \Rabbit\Cpanel\Facades\Action{
        
        /**
         * 
         *
         * @return \Rabbit\Cpanel\Libraries\Action 
         * @static 
         */
        public static function make(){
            return \Rabbit\Cpanel\Libraries\Action::make();
        }
         ...
         * @static 
         */
        public static function edit($url, $enable = true, $target = '_self'){
            return \Rabbit\Cpanel\Libraries\Action::edit($url, $enable, $target);
        }
         ...
         * @static 
         */
        public static function delete($url, $item = '', $enable = true, $target = '_self'){
            return \Rabbit\Cpanel\Libraries\Action::delete($url, $item, $enable, $target);
        }
         ...
         * @static 
         */
        public static function show($url, $enable = true, $target = '_self'){
            return \Rabbit\Cpanel\Libraries\Action::show($url, $enable, $target);
        }
         ...
         * @static 
         */
        public static function custom($url, $title, $enable = true, $target = '_self'){
            return \Rabbit\Cpanel\Libraries\Action::custom($url, $title, $enable, $target);
        }
        ...
        public static function divider(){
            return \Rabbit\Cpanel\Libraries\Action::divider();
        }
        ...
        public static function header($title){
            return \Rabbit\Cpanel\Libraries\Action::header($title);
        }
        ...
        public static function get(){
            return \Rabbit\Cpanel\Libraries\Action::get();
        }
        
    }


    class FormProperty extends \Rabbit\Cpanel\Facades\FormProperty{
        ...
        public static function section($title){
            return \Rabbit\Cpanel\Libraries\FormProperty::section($title);
        }
         ...
         * @static 
         */
        public static function inputLinkAddOn($title, $url, $target = '_blank'){
            return \Rabbit\Cpanel\Libraries\FormProperty::inputLinkAddOn($title, $url, $target);
        }
        
    }


    class IDGenerator extends \Rabbit\Cpanel\Facades\IDGenerator{
         ...
         * @static 
         */
        public static function make($table, $field, $prefix, $suffixLength){
            return \Rabbit\Cpanel\Libraries\IDGenerator::make($table, $field, $prefix, $suffixLength);
        }
        
    }


    class CpanelExcelWriter extends \Rabbit\Cpanel\Facades\CpanelExcelWriter{
         ...
         * @static 
         */
        public static function make($objPHPExcel, $fileName){
            return \Rabbit\Cpanel\Libraries\CpanelExcelWriter::make($objPHPExcel, $fileName);
        }
        
    }


    class CharSequence extends \Rabbit\Cpanel\Facades\CharSequence{
        ...
        public static function newLine($num = 1){
            return \Rabbit\Cpanel\Libraries\CharSequence::newLine($num);
        }
        ...
        public static function space($num = 1){
            return \Rabbit\Cpanel\Libraries\CharSequence::space($num);
        }
        
        /**
         * Full stop with space
         *
         * @param int $num
         * @return string 
         * @static 
         */
        public static function fullStopWithSpace($num = 1){
            return \Rabbit\Cpanel\Libraries\CharSequence::fullStopWithSpace($num);
        }
        
    }


    class CpanelAuth extends \Rabbit\Cpanel\Facades\CpanelAuth{
         ...
         * @static 
         */
        public static function setGroup($id){
            return \Rabbit\Cpanel\Libraries\CpanelAuth::setGroup($id);
        }
         ...
         * @static 
         */
        public static function setBranch($id){
            return \Rabbit\Cpanel\Libraries\CpanelAuth::setBranch($id);
        }
        ...
        public static function getGroup(){
            return \Rabbit\Cpanel\Libraries\CpanelAuth::getGroup();
        }
        ...
        public static function getBranch(){
            return \Rabbit\Cpanel\Libraries\CpanelAuth::getBranch();
        }
        ...
        public static function has(){
            return \Rabbit\Cpanel\Libraries\CpanelAuth::has();
        }
         ...
         */
        public static function clear(){
            return \Rabbit\Cpanel\Libraries\CpanelAuth::clear();
        }
        
    }


    class Currency extends \Rabbit\Cpanel\Facades\Currency{
         ...
         * @static 
         */
        public static function round($currencyID, $amount){
            return \Rabbit\Cpanel\Libraries\Currency::round($currencyID, $amount);
        }
         ...
         * @static 
         */
        public static function format($currencyID, $amount){
            return \Rabbit\Cpanel\Libraries\Currency::format($currencyID, $amount);
        }
         ...
         * @static 
         */
        public static function toKHR($currencyID, $amount, $exchangeID = null, $round = false, $format = false){
            return \Rabbit\Cpanel\Libraries\Currency::toKHR($currencyID, $amount, $exchangeID, $round, $format);
        }
         ...
         * @static 
         */
        public static function toUSD($currencyID, $amount, $exchangeID = null, $round = false, $format = false){
            return \Rabbit\Cpanel\Libraries\Currency::toUSD($currencyID, $amount, $exchangeID, $round, $format);
        }
         ...
         * @static 
         */
        public static function toTHB($currencyID, $amount, $exchangeID = null, $round = false, $format = false){
            return \Rabbit\Cpanel\Libraries\Currency::toTHB($currencyID, $amount, $exchangeID, $round, $format);
        }
        
    }


    class CpanelList extends \Rabbit\Cpanel\Facades\CpanelList{
         ...
         * @static 
         */
        public static function type($selectOne = true){
            return \Rabbit\Cpanel\Libraries\CpanelList::type($selectOne);
        }
         ...
         * @static 
         */
        public static function permission($selectOne = true){
            return \Rabbit\Cpanel\Libraries\CpanelList::permission($selectOne);
        }
         ...
         * @static 
         */
        public static function activated($selectOne = true){
            return \Rabbit\Cpanel\Libraries\CpanelList::activated($selectOne);
        }
         ...
         * @static 
         */
        public static function groupPermission($selectOne = true){
            return \Rabbit\Cpanel\Libraries\CpanelList::groupPermission($selectOne);
        }
         ...
         * @static 
         */
        public static function branchPermission($selectOne = true){
            return \Rabbit\Cpanel\Libraries\CpanelList::branchPermission($selectOne);
        }
         ...
         * @static 
         */
        public static function package($selectOne = true){
            return \Rabbit\Cpanel\Libraries\CpanelList::package($selectOne);
        }
         ...
         * @static 
         */
        public static function branch($selectOne = true){
            return \Rabbit\Cpanel\Libraries\CpanelList::branch($selectOne);
        }
         ...
         * @static 
         */
        public static function group($selectOne = true){
            return \Rabbit\Cpanel\Libraries\CpanelList::group($selectOne);
        }
        
    }


    class CpanelWidget extends \Rabbit\Cpanel\Facades\CpanelWidget{
        ...
        public static function currentDate(){
            return \Rabbit\Cpanel\Libraries\CpanelWidget::currentDate();
        }
        
    }


    class PageHeader extends \Rabbit\Cpanel\Facades\PageHeader{
         ...
         */
        public static function make(){
            return \Rabbit\Cpanel\Libraries\PageHeader::make();
        }
